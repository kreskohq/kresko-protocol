...
export class AccessControlEnumerableUpgradeable__factory {
    ...
    static createInterface(): AccessControlEnumerableUpgradeableInterface {
        return new utils.Interface(_abi) as AccessControlEnumerableUpgradeableInterface;
    }
    static connect(address: string, signerOrProvider: Signer | Provider): AccessControlEnumerableUpgradeable {
        return new Contract(address, _abi, signerOrProvider) as AccessControlEnumerableUpgradeable;
    }
}
