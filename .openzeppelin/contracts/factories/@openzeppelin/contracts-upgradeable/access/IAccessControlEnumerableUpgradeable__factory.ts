...
export class IAccessControlEnumerableUpgradeable__factory {
    ...
    static createInterface(): IAccessControlEnumerableUpgradeableInterface {
        return new utils.Interface(_abi) as IAccessControlEnumerableUpgradeableInterface;
    }
    static connect(address: string, signerOrProvider: Signer | Provider): IAccessControlEnumerableUpgradeable {
        return new Contract(address, _abi, signerOrProvider) as IAccessControlEnumerableUpgradeable;
    }
}
