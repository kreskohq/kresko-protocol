...
export interface FeedsRegistryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "addEthFeed", values: [BytesLike, string]): string;
    encodeFunctionData(functionFragment: "addUsdFeed", values: [BytesLike, string]): string;
    ...
    encodeFunctionData(functionFragment: "getPriceFromSymbol", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "getPriceFromSymbol", data: BytesLike): Result;
...
export type AddFeedEvent = TypedEvent<[string, boolean, string], AddFeedEventObject>;
...
export interface FeedsRegistry extends BaseContract {
    ...
    functions: {
        ...
        getPrice(currencyKey: BytesLike, overrides?: CallOverrides): Promise<[BigNumber] & { price: BigNumber }>;

        getPriceFromSymbol(symbol: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        stringToBytes32(source: string, overrides?: CallOverrides): Promise<[string] & { result: string }>;
    ...
    getPrice(currencyKey: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        addEthFeed(currencyKey: BytesLike, feed: string, overrides?: CallOverrides): Promise<void>;

        addUsdFeed(currencyKey: BytesLike, feed: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        "AddFeed(bytes32,bool,address)"(currencyKey?: BytesLike | null, isEth?: null, feed?: null): AddFeedEventFilter;
        AddFeed(currencyKey?: BytesLike | null, isEth?: null, feed?: null): AddFeedEventFilter;
    ...
    estimateGas: {
        ...
        stringToBytes32(source: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        ethFeeds(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        getPrice(currencyKey: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        getPriceFromSymbol(symbol: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        stringToBytes32(source: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        supportsInterface(interfaceId: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        usdFeeds(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
