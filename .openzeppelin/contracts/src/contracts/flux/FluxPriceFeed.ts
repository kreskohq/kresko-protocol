...
export interface FluxPriceFeedInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "transmit", values: [BigNumberish]): string;
...
export type NewTransmissionEvent = TypedEvent<[number, BigNumber, string], NewTransmissionEventObject>;
