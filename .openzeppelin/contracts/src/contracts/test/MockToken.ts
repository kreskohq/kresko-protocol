...
export interface MockTokenInterface extends utils.Interface {
    ...
    getFunction(
        nameOrSignatureOrTopic: "balanceOf" | "decimals" | "setBalanceOf" | "transfer" | "transferFrom",
    ): FunctionFragment;
...
export interface MockToken extends BaseContract {
    ...
    callStatic: {
        ...
        setBalanceOf(_account: string, _value: BigNumberish, overrides?: CallOverrides): Promise<void>;
