...
export interface KreskoViewerInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "borrowingPowerUSD", values: [string]): string;
    encodeFunctionData(functionFragment: "collateralAssetInfoFor", values: [string]): string;
    encodeFunctionData(functionFragment: "collateralAssetInfos", values: [string[]]): string;
    encodeFunctionData(functionFragment: "getAllowances", values: [string[], string, string]): string;
    encodeFunctionData(functionFragment: "getAssetInfos", values: [string[], string[]]): string;
    encodeFunctionData(functionFragment: "getBalances", values: [string[], string]): string;
    encodeFunctionData(functionFragment: "getTokenMetadatas", values: [string[]]): string;
    encodeFunctionData(functionFragment: "healthFactorFor", values: [string]): string;
    encodeFunctionData(functionFragment: "krAssetInfoFor", values: [string]): string;
    encodeFunctionData(functionFragment: "krAssetInfos", values: [string[]]): string;
    ...
    decodeFunctionResult(functionFragment: "borrowingPowerUSD", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "collateralAssetInfoFor", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "collateralAssetInfos", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getAllowances", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getAssetInfos", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getBalances", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getTokenMetadatas", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "healthFactorFor", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "krAssetInfoFor", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "krAssetInfos", data: BytesLike): Result;
...
export interface KreskoViewer extends BaseContract {
    ...
    functions: {
        ...
        borrowingPowerUSD(_account: string, overrides?: CallOverrides): Promise<[FixedPoint.UnsignedStructOutput]>;

        collateralAssetInfoFor(
            _account: string,
            overrides?: CallOverrides,
        ): Promise<
            [KreskoViewer.CollateralAssetInfoUserStructOutput[], FixedPoint.UnsignedStructOutput] & {
        ...
        getAssetInfos(
            ...
            [KreskoViewer.CollateralAssetInfoStructOutput[], KreskoViewer.KrAssetInfoStructOutput[]] & {
        ...
        healthFactorFor(_account: string, overrides?: CallOverrides): Promise<[FixedPoint.UnsignedStructOutput]>;

        krAssetInfoFor(
            _account: string,
            overrides?: CallOverrides,
        ): Promise<
            [KreskoViewer.KrAssetInfoUserStructOutput[], FixedPoint.UnsignedStructOutput] & {
    ...
    getTokenMetadatas(_tokens: string[], overrides?: CallOverrides): Promise<KreskoViewer.TokenMetadataStructOutput[]>;
    ...
    krAssetInfos(assetAddresses: string[], overrides?: CallOverrides): Promise<KreskoViewer.KrAssetInfoStructOutput[]>;

    kreskoUser(_account: string, overrides?: CallOverrides): Promise<KreskoViewer.KreskoUserStructOutput>;
    ...
    estimateGas: {
        ...
        borrowingPowerUSD(_account: string, overrides?: CallOverrides): Promise<BigNumber>;

        collateralAssetInfoFor(_account: string, overrides?: CallOverrides): Promise<BigNumber>;

        collateralAssetInfos(assetAddresses: string[], overrides?: CallOverrides): Promise<BigNumber>;

        getAllowances(_tokens: string[], owner: string, spender: string, overrides?: CallOverrides): Promise<BigNumber>;

        getAssetInfos(_collateralAssets: string[], _krAssets: string[], overrides?: CallOverrides): Promise<BigNumber>;

        getBalances(_tokens: string[], account: string, overrides?: CallOverrides): Promise<BigNumber>;

        getTokenMetadatas(_tokens: string[], overrides?: CallOverrides): Promise<BigNumber>;

        healthFactorFor(_account: string, overrides?: CallOverrides): Promise<BigNumber>;

        krAssetInfoFor(_account: string, overrides?: CallOverrides): Promise<BigNumber>;

        krAssetInfos(assetAddresses: string[], overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        borrowingPowerUSD(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        collateralAssetInfoFor(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        collateralAssetInfos(assetAddresses: string[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getBalances(_tokens: string[], account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        getTokenMetadatas(_tokens: string[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

        healthFactorFor(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        krAssetInfoFor(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        krAssetInfos(assetAddresses: string[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

        kreskoUser(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
