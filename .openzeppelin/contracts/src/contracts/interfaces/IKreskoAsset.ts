...
export interface IKreskoAsset extends BaseContract {
    ...
    functions: {
        OPERATOR_ROLE(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
    ...
    estimateGas: {
        OPERATOR_ROLE(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    populateTransaction: {
        OPERATOR_ROLE(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
