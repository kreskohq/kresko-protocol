...
export interface INonRebasingWrapperToken extends BaseContract {
    ...
    functions: {
        ...
        underlyingToken(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
    ...
    estimateGas: {
        ...
        underlyingToken(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        underlyingToken(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
