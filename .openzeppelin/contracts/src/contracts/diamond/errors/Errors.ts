...
export interface ErrorsInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "ACCOUNT_NOT_LIQUIDATABLE", values?: undefined): string;
    encodeFunctionData(functionFragment: "ADDRESS_INVALID_COLLATERAL", values?: undefined): string;
    encodeFunctionData(functionFragment: "ADDRESS_INVALID_FEERECIPIENT", values?: undefined): string;
    encodeFunctionData(functionFragment: "ADDRESS_INVALID_NRWT", values?: undefined): string;
    encodeFunctionData(functionFragment: "ADDRESS_INVALID_ORACLE", values?: undefined): string;
    encodeFunctionData(functionFragment: "ADDRESS_INVALID_REWARD_RECIPIENT", values?: undefined): string;
    encodeFunctionData(functionFragment: "COLLATERAL_EXISTS", values?: undefined): string;
    encodeFunctionData(functionFragment: "COLLATERAL_INVALID_FACTOR", values?: undefined): string;
    encodeFunctionData(functionFragment: "COLLATERAL_WITHDRAW_OVERFLOW", values?: undefined): string;
    encodeFunctionData(functionFragment: "CONTRACT_ALREADY_INITIALIZED", values?: undefined): string;
    encodeFunctionData(functionFragment: "KRASSET_BURN_AMOUNT_OVERFLOW", values?: undefined): string;
    encodeFunctionData(functionFragment: "KRASSET_EXISTS", values?: undefined): string;
    encodeFunctionData(functionFragment: "KRASSET_INVALID_FACTOR", values?: undefined): string;
    encodeFunctionData(functionFragment: "NOT_OPERATOR", values?: undefined): string;
    encodeFunctionData(functionFragment: "NOT_OWNER", values?: undefined): string;
    encodeFunctionData(functionFragment: "PARAM_BURN_FEE_TOO_HIGH", values?: undefined): string;
    encodeFunctionData(functionFragment: "PARAM_LIQUIDATION_INCENTIVE_HIGH", values?: undefined): string;
    encodeFunctionData(functionFragment: "PARAM_LIQUIDATION_INCENTIVE_LOW", values?: undefined): string;
    encodeFunctionData(functionFragment: "PARAM_MIN_COLLATERAL_RATIO_LOW", values?: undefined): string;
    encodeFunctionData(functionFragment: "PARAM_MIN_DEBT_AMOUNT_LOW", values?: undefined): string;
    encodeFunctionData(functionFragment: "POOL_DOESNT_EXIST", values?: undefined): string;
    encodeFunctionData(functionFragment: "POOL_EXISTS", values?: undefined): string;
    encodeFunctionData(functionFragment: "REWARD_PER_BLOCK_MISSING", values?: undefined): string;
    encodeFunctionData(functionFragment: "REWARD_TOKENS_MISSING", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "ZERO_DEPOSIT", values?: undefined): string;
    encodeFunctionData(functionFragment: "ZERO_MINT", values?: undefined): string;
    encodeFunctionData(functionFragment: "ZERO_WITHDRAW", values?: undefined): string;

    decodeFunctionResult(functionFragment: "ACCOUNT_NOT_LIQUIDATABLE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ADDRESS_INVALID_COLLATERAL", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ADDRESS_INVALID_FEERECIPIENT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ADDRESS_INVALID_NRWT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ADDRESS_INVALID_ORACLE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ADDRESS_INVALID_REWARD_RECIPIENT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "COLLATERAL_EXISTS", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "COLLATERAL_INVALID_FACTOR", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "COLLATERAL_WITHDRAW_OVERFLOW", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "CONTRACT_ALREADY_INITIALIZED", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "KRASSET_BURN_AMOUNT_OVERFLOW", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "KRASSET_EXISTS", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "KRASSET_INVALID_FACTOR", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "NOT_OPERATOR", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "NOT_OWNER", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "PARAM_BURN_FEE_TOO_HIGH", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "PARAM_LIQUIDATION_INCENTIVE_HIGH", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "PARAM_LIQUIDATION_INCENTIVE_LOW", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "PARAM_MIN_COLLATERAL_RATIO_LOW", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "PARAM_MIN_DEBT_AMOUNT_LOW", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "POOL_DOESNT_EXIST", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "POOL_EXISTS", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "REWARD_PER_BLOCK_MISSING", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "REWARD_TOKENS_MISSING", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "ZERO_DEPOSIT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ZERO_MINT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ZERO_WITHDRAW", data: BytesLike): Result;
...
export interface Errors extends BaseContract {
    ...
    estimateGas: {
        ...
        ADDRESS_INVALID_REWARD_RECIPIENT(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        PARAM_LIQUIDATION_INCENTIVE_HIGH(overrides?: CallOverrides): Promise<BigNumber>;

        PARAM_LIQUIDATION_INCENTIVE_LOW(overrides?: CallOverrides): Promise<BigNumber>;

        PARAM_MIN_COLLATERAL_RATIO_LOW(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ACCOUNT_NOT_LIQUIDATABLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        ADDRESS_INVALID_COLLATERAL(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        ADDRESS_INVALID_FEERECIPIENT(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        ADDRESS_INVALID_NRWT(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        ADDRESS_INVALID_ORACLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        ADDRESS_INVALID_REWARD_RECIPIENT(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        COLLATERAL_EXISTS(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        COLLATERAL_INVALID_FACTOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        COLLATERAL_WITHDRAW_OVERFLOW(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        CONTRACT_ALREADY_INITIALIZED(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        KRASSET_BURN_AMOUNT_OVERFLOW(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        KRASSET_EXISTS(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        KRASSET_INVALID_FACTOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        PARAM_BURN_FEE_TOO_HIGH(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        PARAM_LIQUIDATION_INCENTIVE_HIGH(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        PARAM_LIQUIDATION_INCENTIVE_LOW(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        PARAM_MIN_COLLATERAL_RATIO_LOW(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        PARAM_MIN_DEBT_AMOUNT_LOW(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        REWARD_PER_BLOCK_MISSING(overrides?: CallOverrides): Promise<PopulatedTransaction>;

        REWARD_TOKENS_MISSING(overrides?: CallOverrides): Promise<PopulatedTransaction>;
