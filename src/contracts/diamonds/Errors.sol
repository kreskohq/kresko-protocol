...
library Error {
    ...
    string public constant INVALID_FUNCTION_SIGNATURE = "krDiamond: function does not exist";
    ...
    string public constant CONTRACT_ALREADY_INITIALIZED = "105"; // Contract has already been initialized
    ...
    string public constant PARAM_MIN_DEBT_AMOUNT_LOW = "217"; // Minimum debt amount less than MAX_DEBT_VALUE
