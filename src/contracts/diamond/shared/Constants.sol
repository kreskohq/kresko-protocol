...
library Roles {
    ...
    bytes32 internal constant MINTER_OPERATOR = keccak256("kresko.roles.minter.operator");
    bytes32 internal constant MINTER_HELPER_CONTRACT = keccak256("kresko.roles.minter.helper");
}
