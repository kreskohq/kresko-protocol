...
contract PeripheryTest is Tested, Deploy {
    ...
    uint256 constant ASSET_COUNT = 14;
    ...
    function testProtocolDatas() public {
        ...
        protocol.scdp.deposits.length.eq(9, "scdp.deposits.length");
        ...
        protocol.scdp.debts.length.eq(8, "scdp.debts.length");
    ...
    function testUserDatas() public {
        PType.Account memory acc = dataV1.getAccount(user0, rsPayload).protocol;
        ...
        acc.minter.debts.length.eq(7, "acc.minter.deposits.length");
        ...
        /* ------------------------------ user2 ----------------------------- */
        PType.Account memory acc2 = dataV1.getAccount(user2, rsPayload).protocol;
        ...
        acc2.minter.debts.length.eq(7, "acc2.minter.debts.length");
    ...
    function testUserDatasPushPriced() public {
        ...
        /* ------------------------------ user2 ----------------------------- */
        PType.Account memory acc2 = dataV1.getAccountPushPriced(user2).protocol;
        acc2.addr.eq(user2, "acc2.addr");
