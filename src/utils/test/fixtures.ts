...
import { KreskoAssetAnchor, SmockCollateralReceiver, SmockCollateralReceiver__factory } from 'src/types/typechain';
import { Kresko } from 'src/types/typechain/hardhat-diamond-abi/HardhatDiamondABI.sol/Kresko';
