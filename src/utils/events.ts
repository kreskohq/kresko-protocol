...
// Extracts internal events from a transaction receipt
export async function extractInternalIndexedEventsFromTxReceipt<T extends typeof Event["arguments"] = Event>(
    tx: ContractTransaction,
    contract: Contract,
    eventName: string,
): Promise<T[]> {
