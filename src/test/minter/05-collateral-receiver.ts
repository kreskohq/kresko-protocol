  ...
  describe('#unchecked-collateral-withdrawal', () => {
    ...
    describe('#unchecked-withdraw-reverts', () => {
      ...
      it('should revert if under MCR after withdrawal', async function () {
        ...
        await expect(f.Receiver.test(f.Collateral.address, maxWithdrawAmount.add((0.5e18).toString()))).to.be.reverted;
      });
      ...
      it('should revert if under MCR after redeposit', async function () {
        ...
        await expect(
          Receiver.testInsufficientRedeposit(f.Collateral.address, maxWithdrawAmount.add((0.5e18).toString())),
        ).to.be.reverted;
      });
    });
  });
