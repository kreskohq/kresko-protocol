...
export interface CommonStateFacetInterface extends utils.Interface {
  functions: {
...
export interface CommonStateFacet extends BaseContract {
  contractName: 'CommonStateFacet';

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CommonStateFacetInterface;
