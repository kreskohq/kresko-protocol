...
export interface AssetStateFacetInterface extends utils.Interface {
  functions: {
...
export interface AssetStateFacet extends BaseContract {
  contractName: 'AssetStateFacet';

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AssetStateFacetInterface;
