...
export interface SafetyCouncilFacetInterface extends utils.Interface {
  functions: {
...
export interface SafetyCouncilFacet extends BaseContract {
  contractName: 'SafetyCouncilFacet';

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafetyCouncilFacetInterface;
