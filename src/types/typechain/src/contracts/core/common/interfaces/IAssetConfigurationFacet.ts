...
export interface IAssetConfigurationFacetInterface extends utils.Interface {
  functions: {
...
export interface IAssetConfigurationFacet extends BaseContract {
  contractName: 'IAssetConfigurationFacet';

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAssetConfigurationFacetInterface;
