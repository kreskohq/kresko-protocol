...
export interface IKreskoAssetAnchorInterface extends utils.Interface {
  functions: {
...
export interface IKreskoAssetAnchor extends BaseContract {
  contractName: 'IKreskoAssetAnchor';

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IKreskoAssetAnchorInterface;
  ...
  callStatic: {
    ...
    unwrap(assets: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    ...
    wrap(assets: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
  };
