...
export interface IStateFacetInterface extends utils.Interface {
  functions: {
...
export interface IStateFacet extends BaseContract {
  contractName: 'IStateFacet';

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IStateFacetInterface;
  ...
  functions: {
    ...
    getKrAssetExists(_krAsset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    getKrAssetExists(_krAsset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getKrAssetExists(_krAsset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
