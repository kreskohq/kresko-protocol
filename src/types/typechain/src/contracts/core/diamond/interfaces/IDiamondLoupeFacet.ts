...
export interface IDiamondLoupeFacetInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'facetAddress' | 'facetAddresses' | 'facetFunctionSelectors' | 'facets',
  ): FunctionFragment;
...
export interface IDiamondLoupeFacet extends BaseContract {
  contractName: 'IDiamondLoupeFacet';

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDiamondLoupeFacetInterface;
