...
export interface IERC165FacetInterface extends utils.Interface {
  functions: {
...
export interface IERC165Facet extends BaseContract {
  contractName: 'IERC165Facet';

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC165FacetInterface;
