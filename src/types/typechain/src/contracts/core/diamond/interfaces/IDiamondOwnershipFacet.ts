...
export interface IDiamondOwnershipFacetInterface extends utils.Interface {
  functions: {
...
export interface IDiamondOwnershipFacet extends BaseContract {
  contractName: 'IDiamondOwnershipFacet';

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDiamondOwnershipFacetInterface;
