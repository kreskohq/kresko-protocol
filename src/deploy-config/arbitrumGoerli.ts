...
const redstoneTestAssets = {
    Collateral: ethers.utils.formatBytes32String("Collateral"),
    KreskoAsset: ethers.utils.formatBytes32String("KreskoAsset"),
    KreskoAsset2: ethers.utils.formatBytes32String("KreskoAsset2"),
    KreskoAssetPrice10USD: ethers.utils.formatBytes32String("KreskoAssetPrice10USD"),
    CollateralAsset: ethers.utils.formatBytes32String("CollateralAsset"),
    CollateralAssetNew: ethers.utils.formatBytes32String("CollateralAssetNew"),
    Collateral18Dec: ethers.utils.formatBytes32String("Collateral18Dec"),
    Collateral8Dec: ethers.utils.formatBytes32String("Collateral8Dec"),
    Collateral21Dec: ethers.utils.formatBytes32String("Collateral21Dec"),
    CollateralAsset8Dec: ethers.utils.formatBytes32String("CollateralAsset8Dec"),
    KreskoAssetLiquidation: ethers.utils.formatBytes32String("KreskoAssetLiquidation"),
    SecondKreskoAsset: ethers.utils.formatBytes32String("SecondKreskoAsset"),
    krasset2: ethers.utils.formatBytes32String("krasset2"),
    krasset3: ethers.utils.formatBytes32String("krasset3"),
    krasset4: ethers.utils.formatBytes32String("krasset4"),
    quick: ethers.utils.formatBytes32String("quick"),
    KreskoAssetPrice100USD: ethers.utils.formatBytes32String("KreskoAssetPrice100USD"),
};
