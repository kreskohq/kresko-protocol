...
export interface KreskoInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "MAX_BURN_FEE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_DEBT_VALUE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_LIQUIDATION_INCENTIVE_MULTIPLIER",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MIN_COLLATERALIZATION_RATIO",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MIN_LIQUIDATION_INCENTIVE_MULTIPLIER",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "depositedCollateralAssets",
  ...
  encodeFunctionData(
    functionFragment: "kreskoAssetSymbols",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "mintedKreskoAssets",
    values: [string, BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "secondsUntilStalePrice",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "toggleTrustedContract",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "SecondsUntilStalePriceUpdated"
  ): EventFragment;
...
export type PendingOwnershipTransferEvent = TypedEvent<
  [string, string],
  { previousOwner: string; pendingOwner: string }
>;

export type PendingOwnershipTransferEventFilter =
  TypedEventFilter<PendingOwnershipTransferEvent>;

export type SecondsUntilStalePriceUpdatedEvent = TypedEvent<
  [BigNumber],
  { secondsUntilStalePrice: BigNumber }
>;

export type SecondsUntilStalePriceUpdatedEventFilter =
  TypedEventFilter<SecondsUntilStalePriceUpdatedEvent>;
