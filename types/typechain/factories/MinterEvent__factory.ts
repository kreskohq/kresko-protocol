...
import type { MinterEvent, MinterEventInterface } from "../MinterEvent";
...
const _bytecode =
  "";
...
export class MinterEvent__factory extends ContractFactory {
  ...
  attach(address: string): MinterEvent {
    return super.attach(address) as MinterEvent;
  }
  connect(signer: Signer): MinterEvent__factory {
    return super.connect(signer) as MinterEvent__factory;
  }
  static readonly contractName: "MinterEvent";
  public readonly contractName: "MinterEvent";
