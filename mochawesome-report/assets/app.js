...
!(function (e) {
    ...
    function (e, t, n) {
        ...
        (function (e, r) {
            ...
            function A(e) {
                return (
                    ((2 === e.length || 3 === e.length) && "string" == typeof e[1]) || (4 === e.length && !0 === e[3])
                );
            }
            function I(e, t, n) {
                return Ze(e)
                ...
                try {
                    ...
                    if (r)
                        for (
                            var o = 0, i = r.length;
                            o < i &&
                            (d(!(t = r[o](t)) || t.type, "Intercept handlers should return nothing or a change object"),
                            t);
                            o++
                        );
                    return t;
                            ...
                            (n.namespaces = {
                                ...
                                (n.getHighLow = function (e, t, r) {
                                    var o = {
                                            high:
                                                void 0 ===
                                                (t = n.extend({}, t, r ? t["axis" + r.toUpperCase()] : {})).high
                                                    ? -Number.MAX_VALUE
                                                    : +t.high,
                                                ...
                                                for (d[0] = p[0], d[f - 1] = p[f - 2], s = 1; s < f - 1; s++)
                                                    0 === p[s] || 0 === p[s - 1] || p[s - 1] > 0 != p[s] > 0
                                                        ...
                                                        : ((d[s] =
                                                          ...
                                                          isFinite(d[s]) || (d[s] = 0));
                                                for (
                                                    l = new n.Svg.Path().move(u[0], c[0], !1, o[0]), s = 0;
                                                    s < f - 1;
                                                    s++
                                                )
                                                    l.curve(
        ...
        function D(e, t, n, r) {
            ...
            if (((s = 0), (t = "" === t ? "." : t + ":"), Array.isArray(e)))
                ...
                throw (
                    ((n = "" + e),
                    Error(
                        g(31, "[object Object]" === n ? "object with keys {" + Object.keys(e).join(", ") + "}" : n, ""),
                    ))
                );
            return s;
        }
                    ...
                    : null != e &&
                      (N(e) &&
                          (e = (function (e, t) {
                              ...
                              e,
                              o + (!e.key || (t && t.key === e.key) ? "" : ("" + e.key).replace(C, "$&/") + "/") + n,
                          )),
                      r.push(e));
        }
        ...
        (t.Children = {
            ...
            (t.cloneElement = function (e, t, n) {
                ...
                if (null != t) {
                    ...
                    for (c in t)
                        S.call(t, c) && !O.hasOwnProperty(c) && (o[c] = void 0 === t[c] && void 0 !== u ? u[c] : t[c]);
                }
    ...
    function (e, t, n) {
        ...
        function So(e, t, n) {
            ...
            n
                ? ((e = Eo(e, t, yo)), (r.__reactInternalMemoizedMergedChildContext = e), po(go), po(vo), ho(vo, e))
                : po(go),
                ho(go, n);
        }
        ...
        function oa(e) {
            ...
            return (
                ...
                (e = (e = t.queue =
                    { pending: null, dispatch: null, lastRenderedReducer: ta, lastRenderedState: e }).dispatch =
                    ba.bind(null, $i, e)),
                [t.memoizedState, e]
            );
        }
        ...
        function Qa(e, t, n) {
            ...
            if (
                ...
                if ((void 0 !== i.fallback && Ca(t), s)) {
                    ...
                    return (
                        ((n = Rl(s, o, n, null)).return = t), (i.sibling = n), (t.memoizedState = qa), (t.child = i), n
                    );
                }
        ...
        function Et(e) {
            ...
            var a = e.bind(this),
                ...
                l = new ge.b("".concat(o, "#").concat(i, ".render()"), function () {
                    if (
                        !s &&
                        ((s = !0), "function" == typeof t.componentWillReact && t.componentWillReact(), !0 !== t[lt])
                    ) {
                        var e = !0;
                        try {
                ...
                function t() {
                    ...
                    return (
                        ...
                        (n.renderContextContent = function (e, t) {
                            ...
                            if (Nr()(e))
                                return o.a.createElement(Er, { className: Rr("code-snippet"), code: e, highlight: !1 });
                                        ...
                                        !A &&
                                            o.a.createElement(
                                                ...
                                                o.a.createElement(
                                                    ...
                                                    "" !== m &&
                                                        o.a.createElement("h6", { className: Zr("filename") }, m),
