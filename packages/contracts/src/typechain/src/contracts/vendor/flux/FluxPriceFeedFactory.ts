...
export interface FluxPriceFeedFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "addressOfPricePairId",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "fluxPriceFeeds",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export type FluxPriceFeedCreatedEvent = TypedEvent<
  [string, string],
  FluxPriceFeedCreatedEventObject
>;

export type FluxPriceFeedCreatedEventFilter =
  TypedEventFilter<FluxPriceFeedCreatedEvent>;
