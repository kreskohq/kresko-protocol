...
export interface UniswapV2PairInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "skim(address)", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(
    ...
    decodeFunctionResult(functionFragment: "skim(address)", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "Burn(address,uint256,uint256,address)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "Mint"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "Mint(address,uint256,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "Swap"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "Swap(address,uint256,uint256,uint256,uint256,address)"): EventFragment;
...
export interface UniswapV2Pair extends BaseContract {
    ...
    callStatic: {
        ...
        "mint(address)"(to: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "skim(address)"(to: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
