...
export interface KISSInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "OPERATOR_ROLE_PERIOD",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "operatorRoleTimestamp",
    values?: undefined
  ): string;
...
export type NewMinterInitiatedEvent = TypedEvent<
  [string, BigNumber],
  NewMinterInitiatedEventObject
>;

export type NewMinterInitiatedEventFilter =
  TypedEventFilter<NewMinterInitiatedEvent>;
