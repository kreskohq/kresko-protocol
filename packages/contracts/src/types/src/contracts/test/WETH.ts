...
export interface WETHInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "Withdrawal(address,uint256)"): EventFragment;
}
...
export interface WETH extends BaseContract {
    ...
    callStatic: {
        ...
        "withdraw(uint256)"(wad: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    };
