...
export interface WBTCInterface extends utils.Interface {
    functions: {
        ...
        "toggleMinter(address)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "toggleMinter", values: [PromiseOrValue<string>]): string;
...
export interface wBTC extends BaseContract {
    ...
    callStatic: {
        ...
        toggleMinter(minter: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
