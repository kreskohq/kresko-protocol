...
export interface FunderInterface extends utils.Interface {
    ...
    getFunction(
        nameOrSignatureOrTopic: "distribute" | "drain" | "funded" | "isEligible" | "kresko" | "owners" | "toggleOwners",
    ): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "isEligible", values: [PromiseOrValue<string>]): string;
...
export interface Funder extends BaseContract {
    ...
    functions: {
        ...
        isEligible(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        isEligible(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isEligible(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
