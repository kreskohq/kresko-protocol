...
describe("KreskoAsset", function () {
    ...
    describe("KreskoAsset", function () {
        beforeEach(async function () {
            ...
            this.kreskoAsset = <KreskoAsset>await deployContract(
                this.signers.admin,
                kreskoAssetArtifact,
                [name, symbol],
            );
        ...
        describe("Minting", function () {
            ...
            it("should not allow non-owner addresses to mint tokens", async function () {
                ...
                await expect(this.kreskoAsset.connect(this.userOne).mint(this.userOne.address, this.mintAmount)).
        ...
        describe("Burning", function () {
            ...
            it("should not allow the owner to burn more tokens that it holds", async function () {
                ...
                await expect(this.kreskoAsset.connect(this.signers.admin).burn(overOwnerBalance)).
            ...
            it("should not allow non-owner addresses to burn tokens", async function () {
                await expect(this.kreskoAsset.connect(this.userOne).burn(this.mintAmount)).
                    to.be.revertedWith("Ownable: caller is not the owner");
