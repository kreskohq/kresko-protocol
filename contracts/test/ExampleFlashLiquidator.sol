...
contract ExampleFlashLiquidator is IERC3156FlashBorrower {
    ...
    function onFlashLoan(
        ...
        (address _kreskoUser, address _repayKreskoAsset, address _rewardCollateral, uint256 _repayAmount) =
        ...
        (uint256 collateralIndex, uint256 krAssetIndex) =
            getAssetIndexes(_kreskoUser, _rewardCollateral, _repayKreskoAsset);
